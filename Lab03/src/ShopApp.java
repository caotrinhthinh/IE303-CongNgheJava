...
/**
 * Adidas Shop – Java Swing implementation
 *
 * Layout:
 *   ┌──────────────────────────────────────────┐
 *   │  LEFT (fixed 300px)  │  RIGHT (scrollable grid 4 cols) │
 *   │  Big product image   │  Product cards                  │
 *   │  Name / Price /…     │                                 │
 *   └──────────────────────────────────────────┘
 *
 * Features:
 *  ✅ 8pts – Correct layout matching sample.png
 *  ✅ 1pt  – Click card → update left pane
 *  ✅ 1pt  – Fade-in animation when switching product
 */
